...
public enum StringUtils {
    ...
    public static func slugify(_ text: String) -> String {
        ...
        s = nonWord.stringByReplacingMatches(in: s, range: NSRange(0..<s.utf16.count), withTemplate: "")
        s = spaces.stringByReplacingMatches(in: s, range: NSRange(0..<s.utf16.count), withTemplate: "-")
    ...
    public static func truncate(_ text: String, maxLen: Int = 80, suffix: String = "...") -> String {
        ...
        let endIdx = text.index(text.startIndex, offsetBy: maxLen)
        let truncated = text[..<endIdx]
